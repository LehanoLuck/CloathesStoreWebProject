...
def cart_detail(request, total=0, counter=0, cart_items=None):
    ...
    description = 'Phones for Homies - New Order'
...
def sendEmail(order_id):
    ...
    try:
        subject = "Phones for Homies - New Order #{}".format(transaction.id)
        to = ['{}'.format(transaction.emailAddress)]
        from_email = "orders@phonesforhomies.online"
        order_information = {
